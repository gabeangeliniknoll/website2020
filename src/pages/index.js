...
const IndexPage = () => (
  <Layout>
    ...
    <p>Broadly, I study interactions between algebraic topology, arithmetic and geometry. Specifically, I am interested invariants of ring spectra, such as algebraic K-theory and factorization homology, and interactions with chromatic, equivariant, and motivic homotopy theory. </p>
